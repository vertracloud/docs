---
title: Add Database to Workspace
sidebarTitle: Add Database
api: POST https://api.vertracloud.app/v1/workspaces/{org_id}/databases/{db_id}
authMethod: bearer
description: Adds a database to an workspace by its ID.
---
