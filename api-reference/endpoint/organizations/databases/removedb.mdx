---
title: 'Remove Database from Organization'
sidebarTitle: 'Remove Database'
api: 'DELETE https://api.vertracloud.app/v1/organizations/{org_id}/databases/{db_id}'
authMethod: 'bearer'
description: 'Removes a database from an organization by its ID.'
---
