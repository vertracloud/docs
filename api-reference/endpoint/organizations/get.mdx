...
authMethod: bearer
description: Retrieves details of an workspace by its ID.
---

{/* @see APIWorkspaceInfoResponse — @vertracloud/api-types */}
...
<ResponseField name="code" type="string">
  ...
  - `NOT_ORGANIZATION_MEMBER`: The user is not a member of the workspace.
</ResponseField>
