---
title: 'Add Application to Organization'
sidebarTitle: 'Add App to Org'
api: 'POST https://api.vertracloud.app/v1/organizations/{org_id}/apps/{app_id}'
authMethod: 'bearer'
description: 'Adds an application to an organization by specifying the organization and application IDs.'
---

<ParamField path="org_id" type="string" required>
  The ID of the organization to add the application to.
</ParamField>

<ParamField path="app_id" type="string" required>
  The ID of the application to add to the organization.
</ParamField>
