...
<ParamField path="id" type="string" required>
  The ID of the application to upload a commit for. If the application belongs to a workspace, include the workspace_id in the format `appId-workspace_id`.
</ParamField>
...
<ParamField body="version_increment" type="string" required={false}>
...
<ResponseField name="response" type="object">
  ...
  <ResponseField name="last_snapshot" type="string">
...
```json Response
{
  "response": {
    ...
    "updated_at": "2026-03-14T20:30:00.000Z",
    "last_snapshot": "2026-03-14T20:30:00.000Z"
  }
}
```
</ResponseExample>
