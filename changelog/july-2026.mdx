...
- Replaced the old step-by-step wizard with a single scrolling flow: each stage — source, details, configuration, review, deploy — appears in order as you complete the one before it, instead of jumping between full screens with back/next buttons.
